...
//
	...
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		...
		// employeeRespository.findOne(id); //employees.add(temp);
		/*
		 * User admin = new User(); admin.setEmail("leanhvu86@gmail.com");
...
//		// Member account
		 ...
		 * "  hor: " + palletPositionTemp.getHorizontalAxis() + " ver: " +
		 ...
		 * StockTotalDetail stockTotalDetail = new StockTotalDetail(); Product product =
		 * productRepository.findOne((long) 1); stockTotalDetail.setProduct(product);
		 * stockTotalDetail.setQuantity(100); stockTotalDetail.setAvaiableQuantity(100);
		 * String time1 = "2020-01-01"; // convert String to LocalDateTime // parse it
		 * // to a specified format stockTotalDetail.setExpiredDate("2020-05-20");
		 * stockTotalDetail.setPalletPosition(palletPoisitionRepository.findOne((long)
		 * 1)); stockTotalDetail.setStockTotal(stockTotal);
		 * stockTotalDetail.setProductStatus(1); stockTotalDetail.setUserCreateId(1);
